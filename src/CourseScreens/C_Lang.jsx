  ...
  return (
    <Col style={{ backgroundColor: "#F5F5DC" }}>
      ...
      <p>
        ...
        developed in the early 1970s by Dennis Ritchie at Bell Labs. It has had
        a profound impact on the field of computer science and programming,
        serving as the foundation for many other languages and operating
        systems. Here's an introductory overview of the C programming language:{" "}
        <strong> 1. **Procedural Language**: </strong>C is a procedural
        ...
        simplicity and efficiency. <strong> 2. **Portable**: </strong> C
        programs are highly portable, which means they can be easily transferred
        from one platform to another with minimal modification. This portability
        is due to the minimalistic nature of C and its close-to-hardware
        characteristics. <strong> 3. **Structured Language**: </strong> C
        supports structured programming, allowing developers to write clean and
        organized code using functions and control structures like loops and
        conditionals.{" "}
        <strong> 4. **Low-Level and High-Level Features**: </strong> C offers
        low-level programming capabilities, giving developers direct access to
        memory and system resources, but it also provides high-level
        abstractions for tasks like file I/O and string manipulation.{" "}
        <strong> 5. **Standard Library**: </strong> C comes with a standard
        ...
        management. <strong> 6. **Syntax**: </strong> C has a concise and
        readable syntax. Statements in C are typically terminated by semicolons,
        and functions are defined with a return type, a name, and a list of
      ...
      <Row>
        ...
        <Col md={6} style={{ backgroundColor: "#F5F5DC", padding: "15px" }}>
          <Container fluid>
            <h4 className="text-center">
              <strong>6.</strong> Nested If-Else Statement
            </h4>
            <SyntaxHighlighter
              language="c"
              style={darcula}
      ...
      <Row>
        <Container fluid style={{ backgroundColor: "#F5F5DC" }}>
          <h4 className="text-center">
            <strong>7.</strong> Different Operator
          </h4>
        </Container>
        <Col md={6} style={{ backgroundColor: "#F5F5DC", padding: "15px" }}>
          <Container fluid>
      ...
      <Row>
        <Container fluid style={{ backgroundColor: "#F5F5DC" }}>
          <h4 className="text-center">
            <strong>9.</strong> Loop Concepts (While , Do-While , For)
          </h4>
        </Container>
        <Col md={4} style={{ backgroundColor: "#F5F5DC", padding: "15px" }}>
          <Container fluid>
            <h4 className="text-center">
              <strong>9. (a)</strong> While Loop
            </h4>
            <SyntaxHighlighter
              language="c"
              style={darcula}
        ...
        <Col md={4} style={{ backgroundColor: "#F5F5DC", padding: "15px" }}>
          <Container fluid>
            <h4 className="text-center">
              <strong>9. (b)</strong> Do-While Loop
            </h4>
            <SyntaxHighlighter
              language="c"
              style={darcula}
